...
import { fetchYoutubeVideos } from "../../../FileContainer";

export default function GroupTwoHome() {
  ...
  useEffect(() => {
    try {
      (async () => {
        let res = await fetchYoutubeVideos({ query: "KGF" , maxResults : 1 , SendHetroGeneousVideo : true });
